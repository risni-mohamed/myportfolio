...
import { Github, Linkedin, Mail, ExternalLink, Menu, X, Twitter, Instagram, Facebook, Youtube, MessageCircle, Send, Sun, Moon } from 'lucide-react';
...
`}</style>
            ...
            <div className="relative mb-8">
              <div className="w-44 h-44 rounded-full mx-auto overflow-hidden relative group">
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 p-1 animate-spin-slow">
                  <div className="absolute inset-0 rounded-full bg-gray-900 dark:bg-gray-900"></div>
                </div>
                <div className="absolute inset-1 rounded-full overflow-hidden bg-gradient-to-br from-blue-500/20 to-purple-500/20 dark:from-blue-500/20 dark:to-purple-500/20 group-hover:scale-105 transition-transform duration-500">
                  <img
                    src={profileImage}
                    alt="Risni Rafeek"
      ...
      {/* About Section */}
      <section id="about" className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-100/80 via-gray-50/50 to-gray-100/80 dark:from-gray-800/50 dark:via-gray-900/30 dark:to-gray-800/50 overflow-hidden transition-colors duration-300">
        {/* Background Elements */}
      ...
      {/* Education Section */}
      <section id="education" className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-gray-900/50 dark:via-gray-800/30 dark:to-gray-900/50 overflow-hidden transition-colors duration-300">
        {/* Background Elements */}
      ...
      {/* Footer */}
      <footer className="relative overflow-hidden border-t border-gray-200/50 dark:border-gray-700/50 transition-colors duration-300">
        {/* Background Effects */}
        <div className="absolute inset-0 bg-gradient-to-br from-gray-100 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-black transition-colors duration-300"></div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed max-w-xs mx-auto md:mx-0">
